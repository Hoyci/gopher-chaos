...
type UserServiceClient interface {
	...
	ListUsers(ctx context.Context, in *ListUserRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[UserResponse], error)
}
...
func (c *userServiceClient) ListUsers(ctx context.Context, in *ListUserRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[UserResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[0], UserService_ListUsers_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ListUserRequest, UserResponse]{ClientStream: stream}
...
type UserServiceServer interface {
	...
	ListUsers(*ListUserRequest, grpc.ServerStreamingServer[UserResponse]) error
...
func (UnimplementedUserServiceServer) ListUsers(*ListUserRequest, grpc.ServerStreamingServer[UserResponse]) error {
...
func _UserService_ListUsers_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(UserServiceServer).ListUsers(m, &grpc.GenericServerStream[ListUserRequest, UserResponse]{ServerStream: stream})
}
